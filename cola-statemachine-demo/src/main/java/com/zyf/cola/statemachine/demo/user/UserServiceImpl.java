...
public class UserServiceImpl implements UserService {
    ...
    public boolean audit(UserParam userParam) {
        ...
        // 执行状态机
        final UserAuditState newState = stateMachineEngine.fire(MachineType.TEST_MACHINE, nowState, event, userParam);
    ...
    @Override
    public String uml() {
        return stateMachineEngine.generateUml(MachineType.TEST_MACHINE);
    }
}
